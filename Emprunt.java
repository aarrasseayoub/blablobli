...
public class Emprunt{
    ...
    public EtatEmprunt etatEmprunt(){
        if(this.dateRetourEffective!=null) 
            return EtatEmprunt.RENDU;
        else if(this.dateRetourPrevue.after(new Date()))
            return EtatEmprunt.ENCOURS;
        else 
            return EtatEmprunt.NONRENDU;
    }
    ...
    public String toString(){
        return this.codeEmprunt+" "+this.livre.getTitreLivre()+" "+this.emprunteur+" "+etatEmprunt();
    }
}